package com.example.helloextkafka.api
...
object HelloExtKafkaService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The hello-ext-kafka service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HelloExtKafkaService.
  */
trait HelloExtKafkaService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("hello-ext-kafka")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(HelloExtKafkaService.TOPIC_NAME, greetingsTopic)
